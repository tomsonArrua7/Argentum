VERSION 5.00
Begin VB.Form TorneoPanel4vs4 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Torneo Modalidad: 4 Vs 4"
   ClientHeight    =   6345
   ClientLeft      =   3345
   ClientTop       =   615
   ClientWidth     =   10800
   ...
   Begin VB.Frame Frame2 
      ...
      Begin VB.TextBox Text1 
         ...
         Left            =   5040
         TabIndex        =   37
         Text            =   "Jugador1-Jugador2-Jugador3-Jugador4"
         Top             =   2040
         Width           =   4215
      End
   ...
   End
End
Attribute VB_Name = "TorneoPanel4vs4"
...
Call SendData("/SUM " & ReadField(3, List4, Asc("-")))
Call SendData("/SUM " & ReadField(4, List4, Asc("-")))
Call SendData("/SUM " & ReadField(1, List3, Asc("-")))
Call SendData("/SUM " & ReadField(2, List3, Asc("-")))
Call SendData("/SUM " & ReadField(3, List3, Asc("-")))
Call SendData("/SUM " & ReadField(4, List3, Asc("-")))
End If
End Sub
...
Call SendData("/EXPLOTA " & ReadField(3, List2, Asc("-")))
Call SendData("/EXPLOTA " & ReadField(4, List2, Asc("-")))
...
Call SendData("/PASAN " & ReadField(3, List4, Asc("-")))
Call SendData("/PASAN " & ReadField(4, List4, Asc("-")))
...
Call SendData("/PASAN " & ReadField(3, List1, Asc("-")))
Call SendData("/PASAN " & ReadField(4, List1, Asc("-")))
...
Call SendData("/EXPLOTA " & ReadField(3, List4, Asc("-")))
Call SendData("/EXPLOTA " & ReadField(4, List4, Asc("-")))
...
Call SendData("/EXPLOTA " & ReadField(3, List3, Asc("-")))
Call SendData("/EXPLOTA " & ReadField(4, List3, Asc("-")))
...
Call SendData("/PASAN " & ReadField(3, List3, Asc("-")))
Call SendData("/PASAN " & ReadField(4, List3, Asc("-")))
...
Call SendData("/SUM " & ReadField(3, List1, Asc("-")))
Call SendData("/SUM " & ReadField(4, List1, Asc("-")))
Call SendData("/SUM " & ReadField(1, List2, Asc("-")))
Call SendData("/SUM " & ReadField(2, List2, Asc("-")))
Call SendData("/SUM " & ReadField(3, List2, Asc("-")))
Call SendData("/SUM " & ReadField(4, List2, Asc("-")))
End If
End Sub
...
Call SendData("/PASAN " & ReadField(3, List2, Asc("-")))
Call SendData("/PASAN " & ReadField(4, List2, Asc("-")))
...
Call SendData("/EXPLOTA " & ReadField(3, List1, Asc("-")))
Call SendData("/EXPLOTA " & ReadField(4, List1, Asc("-")))
...
If MsgBox("¿Está seguro que desea cambiar a Modalidad 2vs2?", vbYesNo) = vbYes Then
Unload Me
TorneoPanel.Show
End If
End Sub
